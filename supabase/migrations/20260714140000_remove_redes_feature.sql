-- ───────────────────────────────────────────────────────────────────────
-- Remoção da funcionalidade "Redes" (comunidades) e do Studio.
-- Reverte o feed para mostrar todos os posts (não só os ligados a uma
-- Rede) e apaga as tabelas dedicadas a Redes.
-- ───────────────────────────────────────────────────────────────────────
...
-- ── Apagar tabelas dedicadas a Redes ──────────────────────────────────
DROP TABLE IF EXISTS public.rede_membros CASCADE;
DROP TABLE IF EXISTS public.redes CASCADE;

-- ── Colunas rede_* na tabela posts deixam de ser necessárias ──────────
ALTER TABLE public.posts DROP COLUMN IF EXISTS rede_id;
ALTER TABLE public.posts DROP COLUMN IF EXISTS rede_nome;
ALTER TABLE public.posts DROP COLUMN IF EXISTS rede_username;
ALTER TABLE public.posts DROP COLUMN IF EXISTS rede_avatar_url;
ALTER TABLE public.posts DROP COLUMN IF EXISTS rede_verificada;
