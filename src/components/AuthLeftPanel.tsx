...
export function AuthLeftPanel() {
  return (
    <div className="hidden lg:flex flex-col w-[52%] min-h-screen relative overflow-hidden bg-white">
      ...
      <div style={{ position:"absolute", top:120, right:200, width:34, height:34, borderRadius:"50%", border:"2px solid #2F6FED", opacity:0.5 }} />
      {/* top-center */}
      <div style={{ position:"absolute", top:30, left:"45%", width:44, height:44, borderRadius:"50%", border:"2px solid #2F6FED", opacity:0.35 }} />
      <div style={{ position:"absolute", top:100, left:"55%", width:26, height:26, borderRadius:"50%", border:"2px solid #6BA547", opacity:0.5 }} />
      {/* left side */}
      <div style={{ position:"absolute", top:220, left:18, width:60, height:60, borderRadius:"50%", border:"2.5px solid #2F6FED", opacity:0.18 }} />
      <div style={{ position:"absolute", top:340, left:48, width:30, height:30, borderRadius:"50%", border:"2px solid #2F6FED", opacity:0.4 }} />
      {/* bottom area */}
      ...
      <div style={{ position:"absolute", bottom:80, right:100, width:42, height:42, borderRadius:"50%", border:"2px solid #2F6FED", opacity:0.3 }} />
      <div style={{ position:"absolute", bottom:40, left:"30%", width:28, height:28, borderRadius:"50%", border:"2px solid #2F6FED", opacity:0.3 }} />
      {/* right-center */}
      <div style={{ position:"absolute", top:"50%", right:30, width:50, height:50, borderRadius:"50%", border:"2px solid #2F6FED", opacity:0.25 }} />

      {/* ── Large soft blurred bg circles (colour hints) ── */}
      <div style={{ position:"absolute", top:-60, left:-60, width:320, height:320, borderRadius:"50%", background:"rgba(47,111,237,0.05)" }} />
      <div style={{ position:"absolute", bottom:-80, right:-60, width:360, height:360, borderRadius:"50%", background:"rgba(47,111,237,0.05)" }} />
      ...
      <div className="relative z-10 flex flex-col justify-between h-full px-12 py-12">
        ...
        <div className="mt-auto mb-8">
          <h1 className="font-extrabold tracking-tight leading-[1.1]" style={{ fontSize: "clamp(36px, 4vw, 52px)", color: "#0d0d14" }}>
            Conecta.<br />
            Partilha.<br />
            <span style={{ color: "#2F6FED" }}>Descobre.</span>
          </h1>
        ...
        <div className="relative" style={{ height: 320, marginBottom: 32 }}>
          ...
          <svg style={{ position:"absolute", inset:0, width:"100%", height:"100%", pointerEvents:"none" }}
            ...
            <path d="M 100 180 Q 180 120 210 60" stroke="#2F6FED" strokeWidth="1.5" strokeDasharray="6,5" fill="none" opacity="0.35"/>
            <path d="M 100 180 Q 200 200 220 230" stroke="#2F6FED" strokeWidth="1.5" strokeDasharray="6,5" fill="none" opacity="0.35"/>
            <path d="M 210 60 Q 280 140 220 230" stroke="#2F6FED" strokeWidth="1.5" strokeDasharray="6,5" fill="none" opacity="0.25"/>
          </svg>
