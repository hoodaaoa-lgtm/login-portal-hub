 ...
 *
 * É apenas uma casca fina em volta do BayaPlayer. Toda a lógica de
 * proporção (vertical/horizontal, encolher a largura quando o vídeo é
 * vertical, altura máxima, etc.) vive no BayaPlayer, que lê a proporção
 ...
 * tocava). Removido — o BayaPlayer já resolve tudo sozinho, igual ao
...
interface Props {
  ...
  postId?: string;
  kind?: string;
  /** @deprecated não é mais necessário — o BayaPlayer detecta a proporção real sozinho. Mantido só para não quebrar chamadas antigas. */
  ...
  forceLoad?: boolean;
  /** Ver BayaPlayer — usar valor menor (ex.: 0.42) em espaços pequenos como o modal de comentários. */
