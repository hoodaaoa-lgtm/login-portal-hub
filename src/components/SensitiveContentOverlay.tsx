    ...
    return (
      ...
      >
        ...
        <button
          ...
          style={{ fontSize: 12, fontWeight: 700, color: "var(--accent, #5B3FCF)", background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 4, whiteSpace: "nowrap" }}
        >
