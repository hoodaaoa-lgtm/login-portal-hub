      ...
      >
        ...
        {step === "welcome" && (
          <div className="p-5" style={{ background: `linear-gradient(160deg, ${ACCENT}10, transparent)` }}>
            ...
            <p className="font-extrabold text-[17px] text-black mb-1">Bem-vindo à Snapper! 🎉</p>
            <p className="text-[13px] text-neutral-500 leading-snug mb-4">
              Instala a app e ativa as notificações para nunca perderes uma mensagem ou like novo — mesmo com o telemóvel fechado.
            </p>
            <button
