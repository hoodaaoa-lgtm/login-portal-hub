/**
 * dataSaver — "Snapper Leve", modo de poupar dados.
 *
 ...
 * a dizer que o Snapper Leve está ativo, e só carregam quando o
 * utilizador tocar de propósito em "Ver vídeo".
 *
 * Não afeta vídeo aberto diretamente (post individual, SnapperTV watch,
