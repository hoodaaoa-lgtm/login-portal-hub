      ...
      >
        ...
        {done ? (
          <div className="w-full max-w-[440px] text-center">
              ...
              <div className="relative">
                <div className="w-24 h-24 rounded-full flex items-center justify-center"
                  ...
                  <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none">
                    <rect x="2" y="4" width="20" height="16" rx="3" fill="#2F6FED" opacity="0.12"/>
                    <rect x="2" y="4" width="20" height="16" rx="3" stroke="#2F6FED" strokeWidth="1.8"/>
                    <path d="M2 8l10 6 10-6" stroke="#2F6FED" strokeWidth="1.8" strokeLinecap="round"/>
                    {/* Check badge */}
                ...
                <div className="absolute inset-0 rounded-full animate-ping opacity-20"
                  style={{ background: "#2F6FED", animationDuration: "2s" }} />
              </div>
            </div>
            ...
            <p className="text-[16px] font-bold mb-6" style={{ color: "#2F6FED" }}>
              {email}
            </p>
            ...
            <div className="space-y-3">
              <a
                ...
                style={{ background: "#2F6FED", boxShadow: "0 4px 14px rgba(47,111,237,0.3)" }}
              >
          ...
          <form className="space-y-4" onSubmit={onSubmit}>
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-1.5">
                    {usernameSuggestions.map(s => (
                      <button key={s} type="button"
                        ...
                        style={{
                          borderColor: username === s ? "#2F6FED" : "#d1d5db",
                          background: username === s ? "#2F6FED12" : "var(--s2)",
                          color: username === s ? "#2F6FED" : "var(--text-secondary)",
                        }}>
                        @{s}
                      </button>
                    ))}
            ...
            <label className="flex items-start gap-2.5 pt-1 cursor-pointer select-none">
              <input
                ...
                className="mt-0.5 h-4 w-4 rounded border-neutral-300 text-[#2F6FED] focus:ring-[#2F6FED] focus:ring-offset-0 cursor-pointer"
              />
            ...
            <button
              ...
              style={{ background: "#2F6FED", boxShadow: "0 4px 14px rgba(47,111,237,0.35)" }}
            >
              {loading ? (
            ...
            <p className="text-center text-[14px] text-[var(--text-muted)] pt-1">
              Já tem uma conta?{" "}
              <Link to="/" className="font-bold text-[#2F6FED] hover:text-[#4a2db5] transition-colors">
                Entrar
              </Link>
            </p>
          </form>
