...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Baya, rede social, partilhar vídeos, Baya TV, Baya Studio" },
      { name: "author", content: "Baya" },
      { property: "og:title", content: "Baya — Partilha Vídeos, Fotos e Conversa com Amigos" },
      { property: "og:description", content: "Baya é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "pt_PT" },
      { property: "og:site_name", content: "Baya" },
      { property: "og:url", content: "https://hoode.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Baya — Partilha Vídeos, Fotos e Conversa com Amigos" },
      { name: "twitter:description", content: "Baya é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias." },
      ...
      { name: "apple-mobile-web-app-title", content: "Baya" },
      { name: "application-name", content: "Baya" },
