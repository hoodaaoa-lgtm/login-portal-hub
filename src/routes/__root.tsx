...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Snapper" },
      { property: "og:description", content: "Baya é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias. Cria a tua conta grátis." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "pt_PT" },
      { property: "og:site_name", content: "Baya" },
      { property: "og:url", content: "https://hoode.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Snapper" },
      { name: "twitter:description", content: "Baya é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias. Cria a tua conta grátis." },
