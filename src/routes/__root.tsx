...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Snapper, rede social, partilhar vídeos, Snapper TV, Snapper Studio" },
      { name: "author", content: "Snapper" },
      { property: "og:title", content: "Snapper — Partilha Vídeos, Fotos e Conversa com Amigos" },
      { property: "og:description", content: "Snapper é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "pt_PT" },
      { property: "og:site_name", content: "Snapper" },
      { property: "og:url", content: "https://hoode.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Snapper — Partilha Vídeos, Fotos e Conversa com Amigos" },
      { name: "twitter:description", content: "Snapper é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias." },
      ...
      { name: "msapplication-TileColor", content: "#2F6FED" },
