...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hooda" },
      { name: "description", content: "Hooda Conecte. Crie. Partilhe." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Hooda" },
      { property: "og:description", content: "Hooda Conecte. Crie. Partilhe." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Hooda" },
      { name: "twitter:description", content: "Hooda Conecte. Crie. Partilhe." },
