...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Hooda, rede social, partilhar vídeos, Hooda TV, Hooda Studio" },
      { name: "author", content: "Hooda" },
      { property: "og:title", content: "Hooda — Partilha Vídeos, Fotos e Conversa com Amigos" },
      { property: "og:description", content: "Hooda é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias." },
      ...
      { name: "twitter:description", content: "Hooda é a rede social para partilhares vídeos e fotos, conversares com amigos e descobrires conteúdo novo todos os dias." },
