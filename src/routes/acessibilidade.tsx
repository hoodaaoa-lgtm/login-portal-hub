    ...
    <div className="min-h-screen" style={{ background: "var(--s1)" }}>
      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <Section icon={Accessibility} title="O nosso compromisso">
          <p>A Hooda quer ser usável por todas as pessoas, incluindo quem vive com deficiência visual, auditiva, motora ou cognitiva. Trabalhamos continuamente para melhorar a acessibilidade da plataforma.</p>
        </Section>
        ...
        <Section icon={MessageCircle} title="Contacta-nos">
          <p>Se encontrares uma barreira de acessibilidade na Hooda, avisa-nos através do suporte dentro da app. O teu feedback ajuda-nos a priorizar melhorias.</p>
        </Section>
      </div>
    </div>
  );
