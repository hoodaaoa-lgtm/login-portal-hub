...
// essa sessão no Hooda e seguimos direto para a home — nunca mostra o
// ecrã de login.
        ...
        {failed ? (
          <>
            <p className="text-sm text-neutral-400 text-center max-w-xs">
              Não foi possível entrar automaticamente. Tenta abrir o Hooda outra vez a partir do Studio.
            </p>
            <button
