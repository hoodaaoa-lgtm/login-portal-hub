    ...
    <div className="min-h-screen" style={{ background: "var(--s1)" }}>
      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <Section icon={FileText} title="Aceitação dos termos">
          <p>Ao criares uma conta na Snapper, concordas com estes Termos de Uso e com a nossa Política de Privacidade. Se não concordas, não deves usar a plataforma.</p>
        </Section>
        ...
        <Section icon={AlertTriangle} title="Responsabilidade do utilizador">
          <p>És responsável pelo conteúdo que publicas e pela segurança da tua conta. A Snapper não se responsabiliza por danos resultantes do uso indevido da plataforma por terceiros ou pela perda de acesso devido a partilha de credenciais.</p>
        </Section>

        <Section icon={Scale} title="Propriedade do conteúdo">
          <p>Mantens todos os direitos sobre o conteúdo que publicas. Ao publicares na Snapper, concedes-nos uma licença não exclusiva para exibir e distribuir esse conteúdo dentro da plataforma.</p>
        </Section>
