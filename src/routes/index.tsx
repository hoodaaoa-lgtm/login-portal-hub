            ...
            <>
              ...
              <form className="space-y-4" onSubmit={onSubmit}>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="text-[13px] font-semibold text-[#2F6FED] hover:text-[#4a2db5] transition-colors mt-1"
                    >
                      Esqueceu a senha?
                    </button>
                  </div>
                ...
                <p className="text-center text-[14px] text-[var(--text-muted)] pt-1">
                  ...
                  <Link to="/signup" className="font-bold text-[#2F6FED] hover:text-[#4a2db5] transition-colors">
                    Crie agora
                  </Link>
                </p>
              </form>
